...
using System.Windows.Forms;
    ...
    private void Doc_PrintPage(object sender, PrintPageEventArgs e, DataGridView VerFactura)
    {
        if (VerFactura.SelectedRows.Count > 0)
        {
            ...
            e.Graphics.DrawString("Sistema de de compras Service Azure 1.0", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new Point(50, 75));
            ...
            e.Graphics.DrawString("Precio_servicio: " + Precio_servicio, new Font("Times New Roman", 10, FontStyle.Bold), Brushes.Black, new Point(50, 175));
            ...
            e.Graphics.DrawString("Version Final", new Font("Times New Roman", 8, FontStyle.Bold), Brushes.Crimson, new Point(50, 475));
        }
        else
        {
            MessageBox.Show("No hay ninguna fila seleccionada para imprimir.");
